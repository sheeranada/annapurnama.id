...
<body>
    ...
    <header id="header">
        <div class="container">
            ...
            <h1><a href="index.html">Anna Purnama Gauri</a></h1>
            <!-- Uncomment below if you prefer to use an image logo -->
            <!-- <a href="index.html" class="mr-auto"><img src="assets/img/logo.png" alt="" class="img-fluid"></a> -->
            <h2>Tidak ada kebaikan yang sia-sia</h2>
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="nav-link" href="#contact">Blog</a></li>
        ...
        <div class="about-me container">
            ...
            <div class="row">
                ...
                <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
                    <h3>Anna Purnama Gauri</h3>
                    <p class="fst-italic">
                        Tidak ada yg berarti dalam kehidupan kecuali ketika kita membuat orang lain tersenyum,
                    ...
                    <p>
                        Saya berharap suatu saat nanti dengan keringat saya, dengan perjuangan ini, saya bisa mendirikan
                        sebuah pondok pesantren dimana bisa menampung anak-anak yatim dan membiayai semua fasilitas
                        sekolah dll. Cita cita ini sudah tertanam sejak awal kuliah S1.

                        Semoga dg setapak demi setapak langkah kaki ini, bisa di Rahmati Allah SWT. Hingga cita2 saya
                        terkabul dan bisa menemukan kebahagiaan yg Sejati.
                    </p>
                </div>
            </div>
    ...
    <div class="credits">
        ...
        Copyright@2024 <a href="https://bootstrapmade.com/">annapurnama.id</a>
    </div>
